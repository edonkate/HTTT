...
def cbr_recommendation(weight, height, phase, level, sport, frequently, injury):
    ...
    if(x>0.75):
        print('Lời khuyên:')
        print('Thực đơn ăn uống:', diet_recommendation)
        print('Chế độ tập luyện:', exercise_recommendation)
        print("Lưu ý các bài tập với tạ/thanh đòn có tạ sẽ tập theo mức tạ khi bạn tập hết sức và làm được 10 lần với mức tạ đó")
    else:
        print("Case của bạn chưa thể đưa ra lời khuyên chính xác, chúng tôi sẽ chuyển tới cho chuyên gia và sẽ đưa cho bạn lời khuyên sớm nhất!")
...
def question_process():
    while 1:
        ...
        level = validate_input('Hãy nhập vào cấp độ tập luyện mong muốn: '+'\n'
                            '1. Thấp ' + '\n'
                            '2. Trung bình ' + '\n'
                            '3. Cao ' + '\n', valid_options=[1, 2, 3])
        ...
        freq = validate_input('Hãy nhập thời gian (tần suất) tập luyện mong muốn: '+'\n'
                            '1. Ít (1 - 3 buổi/ tuần)' + '\n'
